...
namespace RADER.Controllers
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        public UsuariosController(RADERContext context)
        {
            _context = context;
        }
        ...
        {
            var query = (from e in _context.Usuario
                         where e.NombreUsuario == user && e.ClaveUsuario == password
                         select new usuarioView
                         {
                           Id_Usuario = e.IdPerfil,
                           Clave_Usuario = password,
                           Id_Perfil = e.IdPerfil, 
                           Nombre_Usuario = user
